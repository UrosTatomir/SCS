...
?>
        ...
        $editresult=$dao->getLastResultScs($id_user);
    ...
    <nav aria-label="breadcrumb" class="col-md-5 offset-md-1">
          <ol class="breadcrumb bg-transparent font-weight-light">
            ...
            <li class="breadcrumb-item active">SCS edit data</li>
          </ol>
    </nav>
    <div class="container">
      ...
      <div class="container p-5 col-md-8 bg-light text-dark">
        ...
        <form action="routes.php" id="scs-form" role="form" style="display: block;">
            ...
            <div class="form-group">
                Naziv rečnog sliva:<input type="text" name="ime" id="ime" tabindex="1" class="form-control form-control-sm" value="<?php echo $pom['ime']; ?>" placeholder="name" required>
                <span style="color:red" ;><?php if (array_key_exists('ime', $errors)) {
                                                echo $errors['ime'];
                                            }  ?></span>
            </div>
            <div class="form-group">
                Merodavno vreme trajanja kiše npr.(10,11,13,14,15,16,...):<input type="text" name="Tkh" id="Tkh" tabindex="2" class="form-control form-control-sm" value="<?php echo $pom['Tkh']; ?>" placeholder="Tkh" required>
            ...
            <div class="form-row">
                <div class="form-group col">
                    <input type="number" name="H24h" step="any" tabindex="9" class="form-control form-control-sm" id="H24h" value="<?php echo $pom['H24h']; ?>" placeholder="H24h [mm] (x.y)" required>
                    <span style="color:red" ;><?php if (array_key_exists('H24h', $errors)) {
                                                    echo $errors['H24h'];
                                                } ?></span>
                </div>
                <div class="form-group col">
                    <input type="number" name="CN" step="any" tabindex="10" class="form-control form-control-sm" id="CN" value="<?php echo $pom['CN']; ?>" placeholder="CN (x.y)" required> <span style="color:red" ;><?php if (array_key_exists('CN', $errors)) {
                             echo $errors['CN'];
                           } ?></span>
                </div>
            </div>
