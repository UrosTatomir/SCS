...
?>
    ...
    <nav aria-label="breadcrumb" class="col-md-6 offset-md-1">
          <ol class="breadcrumb bg-transparent font-weight-light">
            ...
            <li class="breadcrumb-item active">SCS edit result Metoda SCS</li>
          </ol>
    </nav>
    <div class="container">
      ...
      <div class="container p-5 col-md-8 bg-light text-dark">
           <!--<h1 class="text-center" style="font-family: cursive, sans-serif; font-size: 22px;">Proračun Maksimalnog Proticaja "Metoda SCS"</h1>-->
           
        <?php foreach($edit as $pom){ ?>
        
        <form action="routes.php" id="scs-form" role="form" style="display: block;">
            <input type="hidden" name="id_user" value="<?php echo $id_user; ?>">
            <input type="hidden" name="id" value="<?php echo $pom['id'];  ?>">
            <div class="form-group">
                Naziv rečnog sliva:<input type="text" name="ime" id="ime" tabindex="1" class="form-control form-control-sm" value="<?php echo $pom['ime']; ?>" placeholder="name" readonly>
                <span style="color:red" ;><?php if (array_key_exists('ime', $errors)) {
                                                echo $errors['ime'];
                                            }  ?></span>
            </div>
            <div class="form-group">
                Merodavno vreme trajanja kiše uneti niz  npr.(10,11,13,14,15,16,...):<input type="text" name="Tkh" id="Tkh" tabindex="2" class="form-control form-control-sm" value="<?php echo $pom['Tkh']; ?>" placeholder="Tkh" required>
            ...
            <div class="form-group">
                ...
                <select type="number" name="k">
                    <option value="<?php echo $pom['k']; ?>"><?php echo $pom['k']; ?></option>
                    <?php
            ...
            <div class="form-row">
                <div class="form-group col">
                    <input type="number" name="L" step="any" tabindex="4" class="form-control form-control-sm" id="L" value="<?php echo $pom['L']; ?>" placeholder="L [km] (x.y)" required>
                    <span style="color:red" ;><?php if (array_key_exists('L', $errors)) {
                                                    echo $errors['L'];
                                                } ?></span>
                </div>
                <div class="form-group col">
                    <input type="number" name="Lc" step="any" tabindex="5" class="form-control form-control-sm" id="Lc" value="<?php echo $pom['Lc']; ?>" placeholder="Lc [km] (x.y)" required> <span style="color:red" ;><?php if (array_key_exists('Lc', $errors)) {
                                                echo $errors['Lc'];
                                             } ?></span>
                </div>
                <div class="form-group col">
                    <input type="number" name="Iu" step="any" tabindex="6" class="form-control form-control-sm" id="Iu" value="<?php echo $pom['Iu']; ?>" placeholder="Iu [%] (x.y)" required> <span style="color:red" ;>
                    <?php if (array_key_exists('Iu', $errors)) {
                                echo $errors['Iu'];
                           } ?></span>
                </div>
                <div class="form-group col">
                    <input type="number" name="F" step="any" tabindex="7" class="form-control form-control-sm" id="F" value="<?php echo $pom['F']; ?>" placeholder="F [km2] (x.y)" required>
            ...
            <div class="form-group">
                ...
                <select type="number" name="Bm">
                    <option value="<?php echo $pom['Bm']; ?>"><?php echo $pom['Bm']; ?></option>
                    <?php
            ...
            <div class="form-row">
                <div class="form-group col">
                    <input type="number" name="H24h" step="any" tabindex="9" class="form-control" id="H24h" value="<?php echo $pom['H24h']; ?>" placeholder="H24h [mm] (x.y)" required>
                    <span style="color:red" ;><?php if (array_key_exists('H24h', $errors)) {
                                                    echo $errors['H24h'];
                                                } ?></span>
                </div>
                <div class="form-group col">
                    <input type="number" name="CN" step="any" tabindex="10" class="form-control" id="CN" value="<?php echo $pom['CN']; ?>" placeholder="CN (x.y)" required> <span style="color:red" ;><?php if (array_key_exists('CN', $errors)) {
                             echo $errors['CN'];
                           } ?></span>
                </div>
            </div>
            <div class="form-group col-4 ml-n3">
                ...
                <select type="text" name="image_name">
                    <option value="<?php echo $pom['image_name']; ?>"><?php echo $pom['ime_sliva'] , $pom['image_name']; ?></option>
                    <?php
            ...
            <div class="form-group">
                <input type="submit" name="pagescs" id="result" tabindex="11" value="editscs" class="btn btn-primary">
            </div>
